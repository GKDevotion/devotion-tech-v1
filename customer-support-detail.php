...
<style>
    ...
    /* RELATED SYSTEM (single, since only 2 channels) */
    .related-systems { background: var(--cream); }
    .related-single {
        max-width: 480px; margin: 0 auto; background: #fff; border: 1px solid var(--border);
        border-radius: 18px; padding: 30px; display: flex; align-items: center; gap: 20px;
        transition: all .25s ease;
    }
    .related-single:hover { transform: translateY(-4px); box-shadow: 0 22px 48px -26px rgba(10,19,48,.25); border-color: var(--gold); }
    .related-single .r-icon { width: 54px; height: 54px; border-radius: 14px; background: #f2e8d3; color: var(--gold-dark); display: flex; align-items: center; justify-content: center; flex: none; }
    .related-single .r-icon svg { width: 24px; height: 24px; }
    .related-single h4 { font-size: 1.05rem; font-weight: 700; color: var(--navy); margin-bottom: 4px; }
    .related-single span { font-size: .86rem; color: var(--muted); }
    ...
    @media (max-width: 600px) {
        ...
        .related-single { flex-direction: column; text-align: center; }
    }
</style>
    ...
    <div class="container">
        <div class="sys-hero-inner">
            <div class="sys-hero-main">
                <div class="sys-hero-icon"><?php echo cs_icon($csIcons, $system['icon']); ?></div>
...
<section>
    <div class="container">
        <div class="section-head">
            ...
            <p>The same disciplined rollout applies whether this runs standalone or alongside your other support channel.</p>
        </div>
        <div class="timeline">
...
<section class="related-systems">
    <div class="container">
        <div class="section-head">
            ...
            <h2>The other half of your support stack</h2>
        </div>
        <?php foreach ($otherSystems as $rel): ?>
            <a href="customer-support-detail.php?slug=<?php echo urlencode($rel['slug']); ?>" class="related-single">
                <div class="r-icon"><?php echo cs_icon($csIcons, $rel['icon']); ?></div>
                <div>
...
<div class="container" style="padding:100px 24px;text-align:center;">
    <h1 style="font-size:1.8rem;font-weight:700;color:var(--navy);margin-bottom:12px;">Channel not found</h1>
    <p style="color:var(--muted);margin-bottom:24px;">We couldn't find that support channel. It may have been renamed or removed.</p>
